...
\titleformat{\subsection}
  {\large\bfseries\color{darkblue}}{\thesubsection\enspace}{0em}{#1}
\titleformat{\subsubsection}
  {\normalsize\bfseries\color{medblue}}{\thesubsubsection\enspace}{0em}{#1}
\titleformat{\paragraph}[runin]
  {\normalsize\bfseries\color{teal}}{}{0em}{#1}[\;\enspace]
